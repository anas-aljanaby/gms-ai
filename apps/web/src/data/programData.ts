...
export const MOCK_SDGS: SDG[] = [
    { id: 1, name: "No Poverty", description: "End poverty in all its forms everywhere.", color: "#E5243B", isEnabled: true },
    { id: 2, name: "Zero Hunger", description: "End hunger and improve food security and nutrition.", color: "#DDA63A", isEnabled: true },
    { id: 3, name: "Good Health and Well-being", description: "Support healthy lives and well-being for all ages.", color: "#4C9F38", isEnabled: true },
    { id: 4, name: "Quality Education", description: "Promote inclusive, equitable, quality education.", color: "#C5192D", isEnabled: true },
    { id: 5, name: "Gender Equality", description: "Advance equality and empower women and girls.", color: "#FF3A21", isEnabled: true },
    { id: 6, name: "Clean Water and Sanitation", description: "Improve access to safe water and sanitation.", color: "#26BDE2", isEnabled: false },
    { id: 7, name: "Affordable and Clean Energy", description: "Expand access to reliable, sustainable energy.", color: "#FCC30B", isEnabled: false },
    { id: 8, name: "Decent Work and Economic Growth", description: "Promote decent work and inclusive economic growth.", color: "#A21942", isEnabled: true },
    { id: 9, name: "Industry, Innovation and Infrastructure", description: "Build resilient infrastructure and foster innovation.", color: "#FD6925", isEnabled: false },
    { id: 10, name: "Reduced Inequality", description: "Reduce inequality within and among communities.", color: "#DD1367", isEnabled: true },
    { id: 11, name: "Sustainable Cities and Communities", description: "Make cities inclusive, safe, resilient, and sustainable.", color: "#FD9D24", isEnabled: false },
    { id: 12, name: "Responsible Consumption and Production", description: "Encourage sustainable consumption and production patterns.", color: "#BF8B2E", isEnabled: false },
    { id: 13, name: "Climate Action", description: "Strengthen action on climate risk and resilience.", color: "#3F7E44", isEnabled: false },
    { id: 14, name: "Life Below Water", description: "Conserve and sustainably use oceans and marine resources.", color: "#0A97D9", isEnabled: false },
    { id: 15, name: "Life on Land", description: "Protect terrestrial ecosystems and biodiversity.", color: "#56C02B", isEnabled: false },
    { id: 16, name: "Peace, Justice and Strong Institutions", description: "Promote peace, justice, accountability, and strong institutions.", color: "#00689D", isEnabled: true },
    { id: 17, name: "Partnerships for the Goals", description: "Strengthen partnerships that support sustainable development.", color: "#19486A", isEnabled: true },
];
