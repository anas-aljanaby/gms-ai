...
export const MOCK_INCUBATION_DATA: IncubationData = {
    ...
    startups: [
        ...
        { id: 'su-1', name: 'EduGrowth', sector: 'EdTech', description: 'AI-powered platform for personalized learning paths.', logo: 'lightbulb', stage: 'mvp', founder: { name: 'Ali', email: 'ali@edugrowth.com' }, cohortId: 'C-2025-A', mentorIds: ['mentor-1'], investorIds: ['inv-1'], funding: 50000, status: 'active', jobsCreated: 2, financials: { plannedBudget: 50000, actualSpent: 25000 } },
        { id: 'su-2', name: 'FinHealth', sector: 'FinTech', description: 'Mobile app for financial literacy and health for low-income families.', logo: 'coins', stage: 'idea', founder: { name: 'Fatma', email: 'fatma@finhealth.com' }, cohortId: 'C-2025-A', mentorIds: ['mentor-2'], investorIds: [], funding: 0, status: 'active', jobsCreated: 1, financials: { plannedBudget: 30000, actualSpent: 5000 } },
        { id: 'su-3', name: 'AgriConnect', sector: 'AgriTech', description: 'Connecting small-scale farmers to urban markets.', logo: 'sprout', stage: 'growth', founder: { name: 'Youssef', email: 'youssef@agriconnect.com' }, cohortId: 'C-2025-A', mentorIds: ['mentor-1', 'mentor-2'], investorIds: ['inv-1', 'inv-2', 'G-00123'], funding: 150000, status: 'active', jobsCreated: 4, financials: { plannedBudget: 100000, actualSpent: 95000 } },
        { id: 'su-4', name: 'CleanWater Tech', sector: 'Sustainability', description: 'Low-cost water purification solutions for rural areas.', logo: 'droplet', stage: 'mvp', founder: { name: 'Hassan', email: 'hassan@cleanwater.com' }, cohortId: 'C-2025-A', mentorIds: ['mentor-2'], investorIds: [], funding: 25000, status: 'active', financials: { plannedBudget: 25000, actualSpent: 18000 } },
        { id: 'su-5', name: 'Artisan Hub', sector: 'E-commerce', description: 'Online marketplace for traditional crafts.', logo: 'palette', stage: 'idea', founder: { name: 'Noura', email: 'noura@artisan.com' }, cohortId: 'C-2025-A', mentorIds: ['mentor-1'], investorIds: ['inv-2'], funding: 10000, status: 'active', financials: { plannedBudget: 15000, actualSpent: 16000 } },
        { id: 'su-6', name: 'RecycleRight', sector: 'Sustainability', description: 'Gamified app to encourage household recycling.', logo: 'recycle', stage: 'growth', founder: { name: 'Khalid', email: 'khalid@recycle.com' }, cohortId: 'C-2025-A', mentorIds: ['mentor-1'], investorIds: [], funding: 75000, status: 'active', financials: { plannedBudget: 60000, actualSpent: 30000 } },
        { id: 'su-7', name: 'HealthBot', sector: 'HealthTech', description: 'A chatbot for preliminary medical diagnosis and advice.', logo: 'bot', stage: 'mvp', founder: { name: 'Amina', email: 'amina@healthbot.com' }, cohortId: 'C-2025-A', mentorIds: ['mentor-2'], investorIds: ['inv-1'], funding: 60000, status: 'active', financials: { plannedBudget: 60000, actualSpent: 45000 } },
        { id: 'su-8', name: 'SolarKit', sector: 'CleanTech', description: 'Affordable solar energy kits for off-grid homes.', logo: 'sun', stage: 'idea', founder: { name: 'Bilal', email: 'bilal@solarkit.com' }, cohortId: 'C-2025-A', mentorIds: [], investorIds: [], funding: 0, status: 'active', financials: { plannedBudget: 40000, actualSpent: 2000 } },
    ],
    cohorts: [
