        ...
        <div className={`transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'max-h-96' : 'max-h-0'}`}>
            <div className="p-4 mb-4 bg-gray-50 dark:bg-dark-card/50 rounded-xl border dark:border-slate-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div><label className="text-sm">{t('institutional_donors.filter_labels.institutionType')}</label><select className="w-full p-2 mt-1 border rounded-md bg-white dark:bg-slate-800 dark:border-slate-600"><option>{t('institutional_donors.filterAll')}</option></select></div>
                    <div><label className="text-sm">{t('institutional_donors.filter_labels.relationshipStatus')}</label><select className="w-full p-2 mt-1 border rounded-md bg-white dark:bg-slate-800 dark:border-slate-600"><option>{t('institutional_donors.filterAll')}</option></select></div>
                    ...
                    <div><label className="text-sm">{t('institutional_donors.filter_labels.priorityLevel')}</label><select className="w-full p-2 mt-1 border rounded-md bg-white dark:bg-slate-800 dark:border-slate-600"><option>{t('institutional_donors.filterAll')}</option></select></div>
                </div>
