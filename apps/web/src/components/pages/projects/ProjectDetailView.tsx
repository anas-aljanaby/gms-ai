...
const ProjectDetailView: React.FC<ProjectDetailViewProps> = ({ project, beneficiaries, onBack, initialTab }) => {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'scope': return <ScopeManagementTab project={project} />;
            case 'schedule': return <ScheduleManagementTab project={project} />;
            case 'cost': return <CostManagementTab project={project} isInitiallyActive={initialTab === 'cost'} />;
            case 'hr': return <HumanResourcesTab project={project} />;
            case 'risks': return <RiskManagementTab project={project} />;
            case 'quality': return <QualityManagementTab project={project} />;
            ...
            case 'changeLog': return <ChangeLogTab project={project} />;
